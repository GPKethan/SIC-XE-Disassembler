...
string Optab::getOpcode(string key) {
...
string Optab::getMnemonic(char first, char second) {

	string secondInBinary = Convert::hexToBinary(second);
	secondInBinary[secondInBinary.size() - 1] = '0';
	secondInBinary[secondInBinary.size() - 2] = '0';
...
int Optab::getFormat(string key) {
...
const static unordered_map<string, pair<string, int>> tableData {
...
const unordered_map<string, pair<string, int>> Optab::table = tableData;